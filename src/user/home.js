                        ...
                        <Table className={classes.table} aria-label="simple table">
                            <TableHead>
                                <TableRow className="tableHead">
                                    ...
                                    <TableCell align="left"><span className="headTitle">MARKET CAP</span></TableCell>
                                ...
                                {cryptos.length === 0 ? <div><h3>Fetching Data</h3></div> : <>
                                    {cryptos.map((row) => (
                                        <TableRow key={row.rank} className="tableRow">
                                            ...
                                            <TableCell align="left">{<img src={row.logo_url} className="coinLogo"></img>}&nbsp;&nbsp;&nbsp;&nbsp;<span className="cryptoData">{row.name}</span>&nbsp;&nbsp; {row.currency}</TableCell>
